...
pygame.display.set_caption('Let start racing')
clock = pygame.time.Clock()
 
carImg = pygame.image.load('carIcon1.png')
...
def things_dodged(count):
    ...
    text = font.render("Dodged: "+str(count), True, purple)
...
def game_intro():
    ...
    while intro:
        ...
        gameDisplay.fill(white)
        largeText = pygame.font.SysFont("Helvetica",115)
        TextSurf, TextRect = text_objects("Lets go racing", largeText)
        TextRect.center = ((display_width/2),(display_height/2))
        gameDisplay.blit(TextSurf, TextRect)
